...
| Linux Rootkit (PoC) | Linux rootkit with basic features (process/file/port hiding, backdoors (root, reverse-shell, ssh), ...).  | _not public (but you can find another rootkit PoC [here](/posts/linux-rootkit.md))_ |
| Flipper: LoRa Toolkit | Add LoRa capability to Flipper using an [ESP32 external board](https://heltec.org/project/wifi-lora-32v2/) | _not finished_ |
| Kobalos-rs | Implementing the Kobalos malware obfuscation technique in Rust proc-macros | _not finished_ |
