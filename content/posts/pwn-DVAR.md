...
main setup server listenning, put server process to background and wait for connection. On client connect, it calls `serveconnection` with the client socket as only argument. 
